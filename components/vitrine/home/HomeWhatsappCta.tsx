...
export function HomeWhatsappCta() {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="font-[var(--font-display)] text-[25vw] font-black uppercase leading-none"
      ...
      <div className="relative mx-auto max-w-4xl px-5 text-center">
        ...
        >
          ...
          <h2
            ...
            style={{ fontSize: "clamp(40px, 8vw, 96px)", color: "#fff" }}
          >
            Commander<br />sur WhatsApp
          </h2>
          <p className="mt-6 text-lg font-medium" style={{ color: "rgba(255,255,255,0.65)" }}>
          ...
          <a
            ...
            className="mt-10 inline-flex items-center gap-3 rounded-2xl px-8 py-4 font-[var(--font-display)] text-sm font-black uppercase tracking-widest transition-all hover:scale-[1.03] active:scale-[0.98]"
          ...
          <p
            className="mt-6 font-[var(--font-mono)] text-sm font-bold tracking-wider"
