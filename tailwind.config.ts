  ...
  plugins: [
    heroui({
      themes: {
        dark: {
          colors: {
            primary:   { DEFAULT: "#E8674A", foreground: "#FFFFFF" },
            danger:    { DEFAULT: "#E15B4F", foreground: "#FFFFFF" },
            success:   { DEFAULT: "#2FAF6B", foreground: "#FFFFFF" },
            secondary: { DEFAULT: "#6C6FD9", foreground: "#FFFFFF" },
          },
        },
      },
    }),
